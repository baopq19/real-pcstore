...
import { ErrorToast, SuccessToast } from '../components/shared/CustomToast';
...
export default function RegisterForm() {
	...
	return (
		<div className='flex items-center w-full min-h-screen p-4 mx-auto transition-all duration-500 bg-gray-100 rounded shadow-xl sm:max-w-lg sm:min-h-0 dark:bg-gray-800'>
